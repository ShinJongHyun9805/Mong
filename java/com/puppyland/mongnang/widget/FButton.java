package com.puppyland.mongnang.widget;
...
import static com.puppyland.mongnang.R.color.fbutton_color_alizarin;
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mButtonColor = typedArray.getResources().getColor(fbutton_color_alizarin);
            } else if (attr == R.styleable.FButton_shadowColor) {
                mShadowColor = typedArray.getResources().getColor(fbutton_color_alizarin);
